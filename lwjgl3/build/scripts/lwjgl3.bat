...
set CLASSPATH=%APP_HOME%\lib\Pong-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.josh_mckenzie.pong.lwjgl3.Lwjgl3Launcher %*
